...
from spark.settings import ALLOWED_SIGNUP_DOMAINS
...
class SignUpForm(forms.ModelForm):
    username = forms.CharField(
        ...
        max_length=30,
        required=True,
        help_text='Usernames deve conter <strong>alphanumerico</strong>, <strong>_</strong> e <strong>.</strong> letras')  # noqa: E261
