...
class Profile(models.Model):
    ...
    job_title = models.CharField('cargo', max_length=50, null=True, blank=True)
    url = models.CharField(max_length=50, null=True, blank=True)
    location = models.CharField(
        'endereço', max_length=50, null=True, blank=True)
    area = models.CharField('área', max_length=50, null=True, blank=True)
