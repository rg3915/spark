...
from spark.core.forms import ChangePasswordForm, ProfileForm
from spark.courses.models import Classe
from spark.feeds.models import Feed
from spark.feeds.views import FEEDS_NUM_PAGES, feeds
from spark.courses.views import CLASSES_NUM_PAGES, classes
